        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Solicitacao = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrdemServicoItens_Produtos_ProdutoId",
                        column: x => x.ProdutoId,
                        principalTable: "Produtos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrdemServicoItens_Servicos_ServicoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrdemServicoItens_ProdutoId",
                table: "OrdemServicoItens",
                column: "ProdutoId");

            migrationBuilder.CreateIndex(
                name: "IX_OrdemServicoItens_ServicoId",
                table: "OrdemServicoItens",
                column: "ServicoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrdensServico_EmpresaId_Numero",
                table: "OrdensServico",
